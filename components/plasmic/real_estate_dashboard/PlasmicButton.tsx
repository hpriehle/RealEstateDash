...
import sty from "./PlasmicButton.module.css"; // plasmic-import: otmq_-sWwXFs/css
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <Icon5Icon
                className={classNames(projectcss.all, sty.svg__oHnZf)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <Icon6Icon
                className={classNames(projectcss.all, sty.svg__mFwSb)}
                role={"img"}
              />
            ),
