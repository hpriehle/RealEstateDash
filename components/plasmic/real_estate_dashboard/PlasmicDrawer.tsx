...
import sty from "./PlasmicDrawer.module.css"; // plasmic-import: jBduVDN7iRsf/css
      ...
      triggerSlot={
        (hasVariant($state, "noTrigger", "noTrigger") ? false : true)
          ? renderPlasmicSlot({
              defaultContents: (
                <Button
                  className={classNames("__wab_instance", sty.button___1Qc1A)}
                >
                  <div
                    className={classNames(
                      projectcss.all,
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__vw9VB)}
              >
                <div
                  className={classNames(
                    projectcss.all,
