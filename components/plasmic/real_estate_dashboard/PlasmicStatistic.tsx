...
import sty from "./PlasmicStatistic.module.css"; // plasmic-import: qfHXCYL-eOeW/css
...
function PlasmicStatistic__RenderFunc(props: {
  ...
  return (
    ...
    >
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox__y923O)}>
            <p
              className={classNames(
                projectcss.all,
                projectcss.p,
            ...
            <PlasmicImg__
              alt={""}
              className={classNames(sty.img__xgLlG, {
                [sty.imghideIcon__xgLlGI0Xs]: hasVariant(
                  $state,
                  "hideIcon",
                  "hideIcon"
                )
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__o9Zyd)}
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__uZJlb, {
            [sty.freeBoxhideIcon__uZJlbI0Xs]: hasVariant(
              $state,
              "hideIcon",
              "hideIcon"
            )
        ...
        <div className={classNames(projectcss.all, sty.freeBox__bQldA)}>
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox___1OJqr, {
              [sty.freeBoxhideTrendTracker___1OJqrb84Mb]: hasVariant(
                $state,
                "hideTrendTracker",
                "hideTrendTracker"
              )
          ...
          >
            <div
              className={classNames(projectcss.all, sty.freeBox__mX1Lg, {
                [sty.freeBoxhideTrendTracker__mX1Lgb84Mb]: hasVariant(
                  $state,
                  "hideTrendTracker",
                  "hideTrendTracker"
                )
            ...
            >
              <div className={classNames(projectcss.all, sty.freeBox__i8SqX)}>
                {renderPlasmicSlot({
            ...
            <div className={classNames(projectcss.all, sty.freeBox__f7PGt)}>
              <div className={classNames(projectcss.all, sty.freeBox__iWiZh)}>
                {renderPlasmicSlot({
