...
import sty from "./PlasmicLinkPreview.module.css"; // plasmic-import: VIubIYJ-bkSA/css
...
function PlasmicLinkPreview__RenderFunc(props: {
  ...
  return (
    ...
    >
      <DataCtxReader__>
        {$ctx => (
          <div className={classNames(projectcss.all, sty.freeBox__o8GHy)}>
            <PlasmicImg__
            ...
            <div className={classNames(projectcss.all, sty.freeBox__a9KwN)}>
              <div className={classNames(projectcss.all, sty.freeBox__i9MN)}>
                <h5
