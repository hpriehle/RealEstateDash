...
export type CloseIcon1SvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function CloseIcon1SvgIcon(props: CloseIcon1SvgIconProps) {
...
export default CloseIcon1SvgIcon;
/* prettier-ignore-end */
